...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_TURBO4_0      = 41, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TURBO3_0      = 42, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TURBO2_0      = 43, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TURBO3_TCQ      = 44, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TURBO2_TCQ      = 45, // except 1d tensors
