...
On three GPUs at context 65,536, target-only auto-fit settled near 16.8 t/s and the older manual target-only topology settled near 17.7 t/s. Auto-fit with MTP produced the exact expected sequence in all six requests and averaged about 24.5 t/s, approximately 38% faster than the best target-only profile. The planner retained about 32.0 GiB of projected cache capacity. Physical GPU 3 remained invisible to CUDA and stayed at 1 MiB.
